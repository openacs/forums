...
ad_proc -public forum::is_direct_children {
    {-parent_id:required}
    {-message_id:required}
    {-table_name:required}   
} {
    set direct_children_list [db_list get_direct_children {} ]
    set is_direct_child [lsearch direct_children_list $message_id]
    return $direct_child
}
