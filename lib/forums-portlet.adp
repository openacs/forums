<if @hot_topics:rowcount;literal@ ne 0 and @new_topics:rowcount@ ne 0 or @show_empty_p;literal@ true>
    <if @class@ eq "portalElement">
        <h3><a href="@base_url@">@title@</a></h3>

        <h4>Hot topics</h4>
        <if @hot_topics:rowcount;literal@ eq 0><p>None</p></if><else>
        ...
        <h4>New topics</h4>
        <if @new_topics:rowcount;literal@ eq 0><p>None</p></if><else>
