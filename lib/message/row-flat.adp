<div class="level@message.tree_level@">
  <div id="content@message.message_id@">
    ...
    <div class="content">
      ...
      <div class="attribution">#forums.Posted_by# <a href="user-history?user_id=@message.user_id@">@message.user_name@</a>, <span class="post-date">@message.posting_date_pretty@</span></div>
    </div>
